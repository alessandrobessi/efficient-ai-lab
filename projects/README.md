...
**`quantscope/v0.1.0` tagged** — CI on every push, installable, all
subcommands (`bench` including `--quality-eval`, `predict`, `quantize`,
`report`, `formats`, `cpu-info`) work and are tested end-to-end.
