...
| 16 | Now that Week 4 shows real quality-independent performance differences between quantization formats, how much quality does each one actually cost? | Week 4, [quantization benchmark](../../experiments/04-quantization/README.md#11-what-new-questions-emerged) | Open | Directly planned for Week 5, using [evaluation dataset v1](../../evaluation/datasets/README.md). |
